...
@section('content')
    <main class="bg-gray-900 ml-2 w-screen">
        <div class="bg-white w-1/2 mx-auto my-5 rounded-xl">
            <h2 class="border-b-2 uppercase text-xl p-2 font-semibold">Blogs list</h2>
                    ...
                    <tbody>
                        @foreach ($Blogs as $Blog)
                            <tr class="bg-white border-b  ">
                                ...
                                <td class="px-6 py-4">
                                    <form class="inline" action="{{ route('blog.destroy', $Blog->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="px-6 py-6 lg:px-8">
                                                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">
                                                        Suspended Form</h3>
                                                        <form method="POST" id="unpublishForm" class="space-y-6" action="{{ route('adminBlog', ['category' => 'blogs', 'id' => '__ID__']) }}">
                                                        @csrf
                                                        @method('POST')
                                                        <div>
                                                            <label for="message"
