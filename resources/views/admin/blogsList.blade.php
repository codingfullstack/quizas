                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="px-6 py-6 lg:px-8">
                                                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">
                                                        Suspended Form</h3>
                                                        <form method="POST" id="unpublishForm" class="space-y-6" action="{{ route('adminBlog.suspended', ['category' => 'blogs', 'id' => '__ID__']) }}">
                                                        @csrf
                                                        @method('POST')
                                                        <div>
                                                            <label for="message"
                                        ...
                                        <div class="relative w-full max-w-md max-h-full">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="px-6 py-6 lg:px-8">
                                                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">
                                                        UnSuspended Form</h3>
                                                        <form method="POST" id="publishForm" class="space-y-6" action="{{ route('adminBlog.unsuspended', ['category' => 'blogs', 'id' => '__ID__']) }}">
                                                        @csrf
                                                        @method('POST')
                                                        <div class="flex">
                                                            <div class="flex items-start">
